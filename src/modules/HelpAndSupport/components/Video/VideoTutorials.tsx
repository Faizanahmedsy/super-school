...
export default function VideoTutorials() {
  ...
  const data = [
    {
      videoSrc: 'https://nsc.obs.af-south-1.myhuaweicloud.com/file/tutorial1.mp4',
      thumbnailSrc: '/api/placeholder/640/360',
    },
    {
      videoSrc: 'https://nsc.obs.af-south-1.myhuaweicloud.com/file/tutorial2.mp4',
      thumbnailSrc: '/api/placeholder/640/360',
    },
    {
      videoSrc: 'https://nsc.obs.af-south-1.myhuaweicloud.com/file/tutorial3.mp4',
      thumbnailSrc: '/api/placeholder/640/360',
    },
    {
      videoSrc: 'https://nsc.obs.af-south-1.myhuaweicloud.com/file/tutorial4.mp4',
      thumbnailSrc: '/api/placeholder/640/360',
    },
    {
      videoSrc: 'https://nsc.obs.af-south-1.myhuaweicloud.com/file/tutorial5.mp4',
      thumbnailSrc: '/api/placeholder/640/360',
    },
    {
      videoSrc: 'https://nsc.obs.af-south-1.myhuaweicloud.com/file/tutorial6.mp4',
      thumbnailSrc: '/api/placeholder/640/360',
    },
    {
      videoSrc: 'https://nsc.obs.af-south-1.myhuaweicloud.com/file/tutorial7.mp4',
      thumbnailSrc: '/api/placeholder/640/360',
    },
  ];
